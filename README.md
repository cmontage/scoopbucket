...
最后更新时间: 2026年09月24日 10:48:23

## 统计信息

- main: 1656 个应用程序 + 15 个脚本
- extras: 2389 个应用程序 + 94 个脚本
- versions: 609 个应用程序 + 26 个脚本
- nirsoft: 291 个应用程序
- php: 391 个应用程序
- nonportable: 134 个应用程序 + 3 个脚本
- java: 336 个应用程序
- games: 419 个应用程序 + 5 个脚本
- nerd-fonts: 367 个应用程序
- sysinternals: 76 个应用程序

总计: 6668 个应用程序 + 143 个脚本
