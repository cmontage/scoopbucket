...
最后更新时间: 2026年07月18日 10:00:04

## 统计信息

- main: 1611 个应用程序 + 15 个脚本
- extras: 2348 个应用程序 + 94 个脚本
- versions: 593 个应用程序 + 26 个脚本
- nirsoft: 291 个应用程序
- php: 391 个应用程序
- nonportable: 132 个应用程序 + 3 个脚本
- java: 336 个应用程序
- games: 414 个应用程序 + 5 个脚本
- nerd-fonts: 367 个应用程序
- sysinternals: 75 个应用程序

总计: 6558 个应用程序 + 143 个脚本
