...
最后更新时间: 2026年02月06日 09:43:57

## 统计信息

- main: 1433 个应用程序 + 15 个脚本
- extras: 2257 个应用程序 + 82 个脚本
- versions: 550 个应用程序 + 26 个脚本
- nirsoft: 290 个应用程序
- php: 391 个应用程序
- nonportable: 130 个应用程序 + 3 个脚本
- java: 324 个应用程序 + 1 个脚本
- games: 384 个应用程序 + 5 个脚本
- nerd-fonts: 367 个应用程序
- sysinternals: 75 个应用程序 + 1 个脚本

总计: 6201 个应用程序 + 126 个脚本
